...
type SubModuloInventario = "materia_prima" | "fabricados" | "bodega";

export default function Inventario() {
  const [subModuloActivo, setSubModuloActivo] = useState<SubModuloInventario>("bodega");

  return (
    <div style={{ width: "100%", minHeight: "100vh", backgroundColor: "#000", color: "#fff", padding: "30px", boxSizing: "border-box" }}>
      ...
      <div style={{ marginBottom: "25px", borderBottom: "1px solid rgba(218, 165, 32, 0.3)", paddingBottom: "20px" }}>
        ...
        <div style={{ display: "flex", gap: "10px", flexWrap: "wrap" }}>
          <button
            onClick={() => setSubModuloActivo("materiaprima" as any)}
            style={tabStyle(subModuloActivo === ("materiaprima" as any))}
          >
            📦 MATERIA PRIMA
          </button>
      ...
      <div>
        {(subModuloActivo as string) === "materiaprima" && <MateriaPrima />}
