      ...
      <main style={{ flex: 1, padding: "50px 30px", boxSizing: "border-box", overflowX: "auto" }}>
        ...
        <div style={{ maxWidth: "1300px", margin: "0 auto" }}>
          {seccionActiva === "dashboard" && (
            <div>
              ...
              <div className="card-enterprise" style={{ padding: "40px", marginBottom: "40px" }}>
                ...
                <form onSubmit={handleCrearCampana} style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(220px, 1fr)) auto", gap: "20px", alignItems: "end", marginTop: "20px" }}>
                  <div>
          ...
          {seccionActiva === "campañas" && (
            <div className="card-enterprise" style={{ padding: "40px", overflowX: "auto" }}>
